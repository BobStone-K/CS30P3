...
public class LocalBank {
	...
	private void initialize() {
		...
		actionBox.setModel(new DefaultComboBoxModel(new String[] {"Add an account", "Remove an account", "Deposit", "Withdrawl", "Check Balance"}));
		...
		JLabel AccountNumberDis = new JLabel("Account number:");
		AccountNumberDis.setForeground(new Color(225, 0, 113));
		AccountNumberDis.setFont(new Font("Tahoma", Font.PLAIN, 13));
		AccountNumberDis.setBounds(21, 102, 169, 20);
		panel.add(AccountNumberDis);
		...
		AmountOfDis.setForeground(new Color(225, 0, 113));
		...
		fNameField.setBounds(21, 226, 383, 20);
